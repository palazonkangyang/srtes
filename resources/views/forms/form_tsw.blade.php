...
<div class="form-group">
  <label for="type-training-text">Course Type:&nbsp;</label><span class="range_text" id="type-training-text">-</span>{!! Form::hidden('type_training',-1,array('id'=>'type_training')) !!}
</div>

<div class="form-group">
   <label for="budget_availability_text">Budget Availability:&nbsp;</label><span class="range_text" id="budget_availability_text">-</span>{!! Form::hidden('budget_availability',-1,array('id'=>'budget_availability')) !!}
</div>

<div class="form-group">
  <label for="isfunds-text">Funds or grant:&nbsp;</label><span class="range_text" id="isfunds-text">-</span>{!! Form::hidden('isfunds',-1,array('id'=>'isfunds')) !!}
</div>

<div id="funds-section" class="form-group hide">
  <label for="funds-text">Amount of Funds / grant:&nbsp;</label><span class="range_text" id="funds-text">-</span>{!! Form::hidden('funds',-1,array('id'=>'funds')) !!}
</div>

<div class="form-group">
  <label for="fee">Course Fee:&nbsp;</label><span class="range_text" id="fee-text">-</span>{!! Form::hidden('fee',1,array('id'=>'fee')) !!}
</div>
