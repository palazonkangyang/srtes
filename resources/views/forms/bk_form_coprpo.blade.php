            ...
            $('#approver_'+len).removeClass('hide').addClass('show');
             document.getElementById("approverfield_"+len).disabled = false;
              $('.po_no').removeClass('hide').addClass('show');
                $('.pr_no').removeClass('hide').addClass('show');
                document.getElementById('chk_pr').checked = true;
                document.getElementById('chk_pr').disabled = true; 
           } else {
         ...
         document.getElementById("approverfield_"+len).disabled = false;
            $('.grn_no').removeClass('hide').addClass('show');
               $('.po_no').removeClass('hide').addClass('show');
                ...
                document.getElementById('chk_pr').checked = true;
                document.getElementById('chk_pr').disabled = true;
                   document.getElementById('chk_po').checked = true;
                document.getElementById('chk_po').disabled = true;
           } else {
            ...
            $('.grn_no').removeClass('hide').addClass('show');
              $('.po_no').removeClass('hide').addClass('show');
                ...
                document.getElementById('chk_pr').disabled = true;
                   document.getElementById('chk_po').checked = true;
                document.getElementById('chk_po').disabled = true;
                   document.getElementById('chk_grn').checked = true;
                document.getElementById('chk_grn').disabled = true;
