  ...
  <div class="row bg-cc-only">
    <div class="col-md-2 bg-cc">Date(s) and Time of booking</div><!-- end col-md-2 -->
  ...
  <div class="row bg-cc-only">
    <div class="col-md-2 bg-cc">Purpose of Use</div><!-- end col-md-2 -->
    <div class="col-md-10 bg-ff">
  ...
  <div class="row bg-cc-only">
    <div class="col-md-2 bg-cc">Layout Arrangement required</div><!-- end col-md-2 -->
    <div class="col-md-10 bg-ff">
     <ol>
  ...
  <div class="row bg-cc-only">
    ...
    <div class="col-md-10 bg-ff">
      <div class="radio">
        ...
        <label>{!! Form::radio('layout_arrangement', 1,True) !!} Theatre Room Style</label>
        <label>{!! Form::radio('layout_arrangement', 2) !!} Classroom Style</label>
        <label>{!! Form::radio('layout_arrangement', 3) !!}  Others</label>

        @elseif($forminfo->layout_arrangement == '2')

        <label>{!! Form::radio('layout_arrangement', 1) !!} Classroom Style</label>
        <label>{!! Form::radio('layout_arrangement', 2,True) !!} Theatre Room Style</label>
        <label>{!! Form::radio('layout_arrangement', 2) !!} Others</label>

        @else

        <label>{!! Form::radio('layout_arrangement', 1) !!} Classroom Style</label>
        <label>{!! Form::radio('layout_arrangement', 2) !!} Theatre Room Style</label>
        <label>{!! Form::radio('layout_arrangement', 3,True) !!} Others</label>
  ...
  <div class="row bg-cc-only">
    <div class="col-md-2 bg-cc">Sound System</div><!-- end col-md-2 -->
    <div class="col-md-10 bg-ff">
  ...
  <div class="row bg-cc-only">
    <div class="col-md-2 bg-cc">Number of Seating</div><!-- end col-md-2 -->
    <div class="col-md-10 bg-ff">
  ...
  <div class="row bg-cc-only">
    <div class="col-md-2 bg-cc">Layout Arrangement</div><!-- end col-md-2 -->
    <div class="col-md-10 bg-ff">
      @if($forminfo->layout_arrangement == 1)
         Theatre Room Style
      @elseif($forminfo->layout_arrangement == 2)
