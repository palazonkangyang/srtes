...
<div class="row">
	<div class="col-md-12">
		<h4 class="page-head-line">Form Management</h4>
	</div>
</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="alert alert-gray">
				<strong>Form Management.</strong> Click each thumbnails link below.
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-6">
			<a href="/tes/form-management/questionnaire-list" class="magic-link">
