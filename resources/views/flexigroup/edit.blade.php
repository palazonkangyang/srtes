...
<div class="row">
    <div class="col-md-12"><h4 class="page-head-line">Edit Group</h4></div>
</div>
      ...
      <div class="panel-heading">
        ...
        <div class="panel-body">
          ...
          @endif
            ...
            {!!Form::open(['url'=>'/controller/updateflexigroup','class'=>'formssettings',])!!} 
            {!! Form::input('hidden','id', $flexigroup->id) !!}	
			...
			<div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                	    {!! Form::input('text','name', $flexigroup->name , array( 'id' => 'name', 'class' => 'form-control')) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                	    {!! Form::input('text','full_name', $flexigroup->full_name , array( 'id' => 'full_name', 'class' => 'form-control')) !!}
              ...
              <div class="form-group col-md-8" style="padding:0">
			    ...
			    <label for="approver">Group members (*)</label>
			      {!! Form::text('',NULL,['class'=>'form-control approver-with-me', 'id'=>'groupmember']) !!}
