<div style="width:500px; margin:0 auto; border:1px solid black; padding:20px;">
	...
	<br />
	<p style="font-family: Arial, sans-serif; font-size:13px; line-height:22px;">
	   Reminder  ,There is an application submitted by {{ $name_submitted }} on {{ $date }},  please click the link <a href="{{ $app_link }}" target="_blank">here</a> for details and processing.
	</p>
	<br />
	<p style="font-family: Arial, sans-serif; font-size:13px; line-height:22px;">
