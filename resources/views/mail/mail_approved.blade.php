<div style="width:500px; margin:0 auto; border:1px solid black; padding:20px;">
	...
	<br />
	<p style="font-family: Arial, sans-serif; font-size:13px; line-height:22px;">
		As one of the Approver, we are happy to inform you that the Case #{{$case_number}} is now <strong>Approved</strong>. please click the link <a href="{{ $url }}" target="_blank">here</a> for more details.
	</p>
	<br />
	<p style="font-family: Arial, sans-serif; font-size:13px; line-height:22px;">
