...
@endif
  ...
  <div class="row pos-rel">
    <div class="col-md-12"><h4 class="page-head-line">Cash Advance in Processing   </h4></div>
  ...
  <div class="wrap-content">
    ...
    {!!Form::open(['route' => 'cashadvance_processing_store','method'=>'post']) !!}
...
>>>>>>> master
  ...
  <div style='width: 100%; text-align: center;'>
    <div style=' display: inline-block;'>
      <a href="{{ URL::route('cashadvance_pending') }}" class="btn btn-default">Previous</a>
      <input type="submit" name="readyforcollection" value="Ready For Collection" class="btn btn-default btn-cs">
      ...
      <a href="{{ URL::route('cashadvance_readyforcollection') }}" class="btn btn-default">Next</a>
      {!! Form::close() !!}
    </div>
  </div>
