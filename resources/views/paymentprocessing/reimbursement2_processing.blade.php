...
<div class="row pos-rel">
  <div class="col-md-12"><h4 class="page-head-line">Reimbursement in Processing   </h4></div>
...
<div class="wrap-content">
  ...
  {!!Form::open(['route' => 'reimbursement2_processing_store','method'=>'post']) !!}
       ...
       <table class="col-md-12 table-bordered table-striped table-condensed cf" id="xls-table">
         ...
         <tbody>
          ...
          <tr>
            ...
            <td data-title="cheque_payable_to"></td>
            <td data-title="project_name">{{ $report-> pcmcf2_project_name }}</td>
...
<br></br>
  ...
  <div style='width: 100%; text-align: center;'>
    <div style='display: inline-block;'>
      <a href="{{ URL::route('reimbursement_processing') }}" class="btn btn-default">Previous</a>
      <input type="submit" name="export" value="Export" class="btn btn-default btn-cs">
      @if(Auth::User()->idsrc_login == $FinHead)
      ...
      <a href="{{ URL::route('reimbursement_exported') }}" class="btn btn-default">Next</a>
      {!! Form::close() !!}
    </div>
  </div>
