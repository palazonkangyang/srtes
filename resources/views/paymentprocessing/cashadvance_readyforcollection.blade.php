...
<div id="no-more-tables">
 ...
 <td>
    ...
    <div class='hide'>{{$grant_total =$grant_total + $report->total }}</div>
        ...
        @endforeach
     <td></td><td></td> <td></td><td></td> <td></td><td></td><td></td> <td>Grant Total:</td><td>{{$grant_total}}</td>
   </tbody>
</table>
</div>
</div>
...
@endif
  ...
  <div style=' display: inline-block;'> 
     <input type="submit" name="collect" value="Collect" class="btn btn-default btn-cs">
