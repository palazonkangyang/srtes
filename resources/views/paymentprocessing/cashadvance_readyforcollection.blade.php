...
@endif
  ...
  <div class="row pos-rel">
    <div class="col-md-12"><h4 class="page-head-line">Cash Advance ready for collection</h4></div>
  ...
  <div class="wrap-content">
    ...
    {!!Form::open(['route' => 'cashadvance_readyforcollection_store','method'=>'post']) !!}
  ...
  <div style='width: 100%; text-align: center;'>
    <div style='display: inline-block;'>
      <a href="{{ URL::route('cashadvance_processing') }}" class="btn btn-default">Previous</a>
      <input type="submit" name="collect" value="Collected" class="btn btn-default btn-cs">
      ...
      <a href="{{ URL::route('cashadvance_collected') }}" class="btn btn-default">Next</a>
      {!! Form::close() !!}
    </div>
  </div>
