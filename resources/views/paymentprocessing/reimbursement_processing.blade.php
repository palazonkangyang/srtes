...
<div class="wrap-content">
    ...
    {!!Form::open(['route' => 'reimbursement_processing_store','method'=>'post']) !!}
...
@endif
  ...
  <div style='width: 100%; text-align: center;'>
    <div style='display: inline-block;'>
      <a href=" {{ URL::route('reimbursement_pending') }}" class="btn btn-default">Pervious</a>
      <input type="submit" name="export" value="Export" class="btn btn-default btn-cs">
       ...
       <a href=" {{ URL::route('reimbursement2_processing') }}" class="btn btn-default">Next</a>
       {!! Form::close() !!}
    </div>
  </div>
@stop
