...
@endif
  ...
  <div class="row pos-rel">
    <div class="col-md-12"><h4 class="page-head-line">Collected Cash Advance  </h4></div>
        ...
        <table class="col-md-12 table-bordered table-striped table-condensed cf" id="xls-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td data-title="S/N">
                <a target="_blank" href="/application/view_reports/{{$report->id}}">{{ $report->case_number }}</a>
              </td>
  ...
  <div style='width: 100%; text-align: center;'>
    <div style='display: inline-block;'>
      <a href="{{ URL::route('cashadvance_readyforcollection') }}" class="btn btn-default">Previous</a>
