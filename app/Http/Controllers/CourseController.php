...
class CourseController extends ControllerCore
{
  ...
  public function store(Request $request)
  {
    ...
    else
    {
      ...
      if($courseModel->save())
      {
        //auto generate questionnaire details
        $coursetypequestionnaireDetailModel = ModelFactory::getInstance('CourseTypeQuestionnaireDetail')
                                              ->where('course_type_id', $request->course_type_id)
                                              ->get();

        foreach($coursetypequestionnaireDetailModel as $data)
        {
          $questonnairedetailModel = ModelFactory::getInstance('QuestionnaireDetail');
          $questonnairedetailModel->course_id = $courseModel->id;
          $questonnairedetailModel->question = $data->question;
          $questonnairedetailModel->answer_input_type = $data->answer_input_type;
          $questonnairedetailModel->answer_input_value = $data->answer_input_value;
          $questonnairedetailModel->additional_text = $data->additional_text;
          $questonnairedetailModel->description_title = $data->description_title;
          $questonnairedetailModel->description_value = $data->description_value;
          $questonnairedetailModel->save();
        }
  ...
  public function update(Request $request)
  {
    ...
    else
    {
      // save user info
      // save course
      $courseModel = ModelFactory::getInstance('Course')->find($request->id);
